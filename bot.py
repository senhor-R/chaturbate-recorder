...
import requests
from config import load_config, get_ytdl_config_path
            ...
            try:
                ...
                for idx, streamer in enumerate(self.config["streamers"]):
                    ...
                    if self.is_online(streamer[0]):
                        ...
                        args = self.config["youtube-dl_cmd"].split(" ") + [
                            "https://chaturbate.com/{}/".format(streamer[0]), "--config-location",
                            get_ytdl_config_path()]

                        # append idx and process to processes list
                        self.processes.append([streamer[0], subprocess.Popen(args, stdin=subprocess.DEVNULL,
